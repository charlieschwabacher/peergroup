...
var GroupServer = (function () {
  function GroupServer(options) {
    ...
    var setUpClientConnection = function setUpClientConnection(ws, id) {
    ...
    var tearDownClientConnection = function tearDownClientConnection(id) {
    ...
    this.on('id', function (id, secret) {
      ...
      if (_this.sockets.has(nextId)) {
        ...
        tearDownClientConnection(id);
        setUpClientConnection(_ws, nextId);
